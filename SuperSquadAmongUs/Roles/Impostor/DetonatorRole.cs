...
public sealed class DetonatorRole(IntPtr cppPtr) : ImpostorRole(cppPtr), ITownOfUsRole, IWikiDiscoverable, IDoomable
{
    ...
    public string IdPart => "Detonator";
    ...
    public List<CustomButtonWikiDescription> Abilities
    {
        get
        {
            ...
            {
                new(MiraLocaleManager.Get($"SuperSquadRole{IdPart}Attach", "Attach"),
                    MiraLocaleManager.Get($"SuperSquadRole{IdPart}AttachWikiDescription"),
