    ...
    : NeutralRole(cppPtr), ITownOfUsRole, IWikiDiscoverable, IDoomable, ICrewVariant
{
    ...
    public Color RoleColor => SuperSquadColors.Sentinel;
    ...
    public CustomRoleConfiguration Configuration => new(this)
    {
        ...
        Icon = SuperSquadRoleIcons.Sentinel,
    ...
    public override void Initialize(PlayerControl player)
    {
        ...
        {
            OffsetButtons();
            HudManager.Instance.ImpostorVentButton.graphic.sprite = SuperSquadNeutAssets.SentinelVentSprite.LoadAsset();
            HudManager.Instance.ImpostorVentButton.buttonLabelText.SetOutlineColor(SuperSquadColors.Sentinel);
        }
    }
